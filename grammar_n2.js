...
var c = new Crawler({
    ...
    callback: function (error, res, done) {
        if (error) {
            ...
            workbook.xlsx.writeFile("grammar_n2.xlsx")
                .then(function () {
                    console.log('ok');
                });
...
c.queue('http://www.n-lab.org/library/mondaidata/test.php?mode=html&dbupdate=0&target=all&type=and&start_num=1&show_num=10&sort=test_num&kyu=2&syu=%E6%96%87%E6%B3%95&word=&submit=%E6%A4%9C%E7%B4%A2');
for (var i = 10; i < 1009; i += 10) {
    c.queue('http://www.n-lab.org/library/mondaidata/test.php?mode=html&dbupdate=0&data_count=1009&jump_num=' + i + '&show_num=10&kyu=2&syu=%E6%96%87%E6%B3%95&target=all&word=&type=and&sort=test_num&test_num=');
}