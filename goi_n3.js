...
var c = new Crawler({
    ...
    callback: function (error, res, done) {
        if (error) {
            ...
            workbook.xlsx.writeFile("goi_n3.xlsx")
                .then(function () {
                    console.log('ok');
                });
...
c.queue('http://www.n-lab.org/library/mondaidata/test.php?mode=html&dbupdate=0&target=all&type=and&start_num=1&show_num=10&sort=test_num&kyu=3&syu=%E8%AA%9E%E5%BD%99&word=&submit=%E6%A4%9C%E7%B4%A2');
for (var i = 10; i < 361; i += 10) {
    c.queue('http://www.n-lab.org/library/mondaidata/test.php?mode=html&dbupdate=0&data_count=362&jump_num=' + i + '&show_num=10&kyu=3&syu=%E8%AA%9E%E5%BD%99&target=all&word=&type=and&sort=test_num&test_num=');
}
